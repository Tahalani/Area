    ...
    <div className="w-screen">
      <div className="navbar w-full pt-10 bg-main">
        <div className="navbar-start">
          <a style={{ fontFamily: 'Londrina'}} className="text-[40px] ml-[132px] text-black"><Link to="/areaPage">NetQ.</Link></a>
        </div>
        ...
        <div className="navbar-end">
          <a style={{ fontFamily: 'merriweather'}} className="pl-[30px] pr-[30px] bg-secondary btn mr-36 text-white rounded-full font-bold" onClick={redirectToLoginPage}>{t("Logout")}</a>
        </div>
      </div>
    </div>
