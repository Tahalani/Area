            ...
            <div className="w-1/2 flex">
              <div className="w-1/5">
                <div className="w-14 h-14">
                  <img src={service} alt="Image" className="w-full h-full object-cover rounded-full" />
                </div>
              </div>
              <div className="w-4/5 ml-auto pt-2">
                <h1 style={{ fontFamily: 'merriweather' }} className="text-left text-[30px] text-black">{service}</h1>
              </div>
            </div>
            <div className="w-1/2 flex flex-col justify-center items-end pr-4">
              <h2 style={{ fontFamily: 'merriweather' }} className="text-[25px] text-black">{service}</h2>
            </div>
          </div>
