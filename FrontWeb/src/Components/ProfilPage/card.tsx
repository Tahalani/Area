      ...
      <>
        <div style={{ border: '1px solid #1400FF' }} className="bg-[#F3F3F3] rounded-lg h-[80%] w-[70%]">
          ...
          {client.surname !== "undefined" ? (
            ...
            <p style={{ fontFamily: 'merriweather' }} className="text-black text-[35px] font-semibold text-center">{ client.name }</p>
          )}
          <div className="flex bg-[#D9D9D9] rounded-full p-1 ml-[25%] mt-8 w-2/4 justify-center">
            <p style={{ fontFamily: 'merriweather' }} className="text-blue-500 text-[25px] font-semibold">Connected</p>
          </div>
          ...
          <div className="bg-white text-left rounded-full p-2 mt-4 w-5/6 ml-[8%] pl-[20px]">
            ...
            {client.surname !== "undefined" ? (
              ...
              <p style={{ fontFamily: 'Inter' }} className="text-[#000000] pl-[3%] text-[20px]">{ client.name }</p>
            )}
          </div>
        </div>
      </>
